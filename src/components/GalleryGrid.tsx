        ...
        <>
            ...
            <AnimatePresence>
                {lightboxIndex !== null && (
                    ...
                    >
                        <button
                            className="absolute top-20 right-5 z-[200] w-12 h-12 flex items-center justify-center rounded-full bg-white hover:bg-white/90 text-[#326789] hover:text-[#e65c4f] shadow-[0_4px_20px_rgba(0,0,0,0.3)] hover:shadow-[0_6px_30px_rgba(0,0,0,0.4)] transition-all duration-200 hover:scale-110"
